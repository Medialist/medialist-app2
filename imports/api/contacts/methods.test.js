...
describe('batchUpdateStatus', function () {
  ...
  it('Should be able to batch update campaign contacts status', function () {
    ...
    assert.equal(updatedCampaign.contacts[0].latestPost.type, 'StatusUpdate')
    assert.equal(updatedCampaign.contacts[1].latestPost.type, 'StatusUpdate')
    assert.equal(updatedCampaign.contacts[2].latestPost.type, 'StatusUpdate')
