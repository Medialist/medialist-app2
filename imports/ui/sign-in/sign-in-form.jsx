...
const SignInForm = React.createClass({
  ...
  render () {
    const form = (
      <Form className='bg-white max-width-2 mt6 p5 mx-auto shadow-2 left-align' onSubmit={this.onSubmit} ref={(form) => { this.form = form }}>
        <p className='semibold f-sm gray10'>Enter your email address to sign in or create a profile on {window.location.hostname}</p>
