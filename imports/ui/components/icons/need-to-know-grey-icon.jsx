...
function NeedToKnowGreyIcon () { return (<span className="svg-icon svg-icon-need-to-know-grey-icon" dangerouslySetInnerHTML={setSvg()}></span>) }
export default NeedToKnowGreyIcon
