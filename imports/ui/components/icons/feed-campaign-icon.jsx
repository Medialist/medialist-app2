...
function FeedCampaignIcon () { return (<span className="svg-icon svg-icon-feed-campaign-icon" dangerouslySetInnerHTML={setSvg()}></span>) }
export default FeedCampaignIcon
