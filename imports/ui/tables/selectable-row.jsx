...
const SelectableRow = ({ selected, active, data, children, onSelectChange, className, ...props }) => (
  <tr className={classnames(className, 'hover-opacity-trigger')} data-id={props['data-id']} data-item={props['data-item']} data-active={active}>
    <td className={classnames('right-align', {'shadow-inset-blue-left': active})} style={{paddingRight: 0}}>
      <Checkbox
